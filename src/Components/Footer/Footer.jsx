  ...
  return (
    <div className="bg-yellow-100 pt-10 pb-20">
      <div className="flex flex-col md:flex-row justify-center gap-14 text-black ">
        ...
        <div className="space-y-2">
          <h2 className="text-lg font-bold pb-2">Order</h2>
          <p>My Account</p>
          <p>View Bag</p>
          <p>Wishlist</p>
          <p>Compare</p>
        ...
        <div className="w-64 space-y-2">
          ...
          <div className="flex items-center">
            <input
              ...
              name="email"
              id=""
              className="border p-2 font-bold w-full text-lg "
      ...
      <div className="lg:ml-52 lg:mt-10">
        ...
        <div className="flex items-center mt-5">
          <img className="w-[70px] h-[50px] mr-4" src={paypal} alt="" />
          <img className="w-[70px] h-[20px] mr-4" src={visa} alt="" />
          <img className="w-[70px] h-[50px] mr-4" src={mastercard} alt="" />
          <img className="w-[50px] h-[30px] mr-4" src={discover} alt="" />
